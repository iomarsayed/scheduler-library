...
4. `ClusterSnapshot.MakePlacement`, `CanSchedulePod`, `SchedulePods`, `SchedulePodsByTemplate`, `SchedulePodGroup`, `PreemptPods`, `Unpreempt` and `Transaction` — the simulation methods.
