...
type Simulator interface {
	...
	// SchedulePodGroup schedules a pod group (or composite pod group) onto the snapshot.
	SchedulePodGroup(ctx context.Context, pods []*v1.Pod, opts snapshot.SchedulePodGroupOptions) ([]snapshot.SchedulingResult, error)
